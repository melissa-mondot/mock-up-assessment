    ...
    <>
      <Container className="footer">
        <div className="business-info d-flex flex-column mt-5 mx-3">
          ...
          <address>
            ...
            <p className="mb-0"><i><Image src={phone} style={{ height: "1rem" }} /></i> 555.555.5555</p>
            <p><i><Image src={email} style={{ height: "1rem" }} /></i> info@companyname.com</p>
      ...
      <Container fluid className="px-0">
        <div className="bg-secondary pt-5">
          <div className="socmed d-flex justify-content-around" style={{ height: "3rem" }}>
